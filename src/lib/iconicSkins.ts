/** Iconic CS skins for landing/auth — real Steam economy images from local data. */
export type SkinAccent = 'covert' | 'classified' | 'rare' | 'restricted'

export interface IconicSkin {
  name: string
  label: string
  image: string
  accent: SkinAccent
...
export const ICONIC_SKINS: IconicSkin[] = [
  {
